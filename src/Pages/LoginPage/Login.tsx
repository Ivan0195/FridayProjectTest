    ...
    return (
        <div>
            <div>
                ...
                <div>
                    <SuperInputText value={email} onChangeText={setEmail} placeholder="email"  error={error ? error : ''} />
                    <SuperInputText value={password} onChangeText={setPassword} placeholder="password" error={error ? error : ''} />
                </div>
